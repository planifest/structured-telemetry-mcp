---
name: build-systems
description: Summarise git changes from the last 7 days into a clean, excited project update — covering key feature changes and upgrades as concise 10-word bullets with a 20-word intro.
argument-hint: "[output of `git log --since='7 days ago' --oneline` or git changelog]"
---
