...
description: Extract structured incident intelligence from cybersecurity breach articles — covering attack type, attacker, target, CVEs, business impact, MITRE ATT&CK mapping, and remediation action plan.
argument-hint: "[paste cybersecurity incident article or breach report]"
---
