---
name: b2b-saas-pm
description: Generate a structured Product Requirements Document (PRD) from a product idea or description — covering overview, objectives, target audience, features, user stories, functional/non-functional requirements, success metrics, and timeline.
argument-hint: "[product idea, feature description, or concept to turn into a PRD]"
---
