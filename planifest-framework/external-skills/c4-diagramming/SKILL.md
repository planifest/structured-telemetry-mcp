---
name: c4-diagramming
description: Turn any concept, system, or data into a Mermaid diagram with a VISUAL EXPLANATION section — use when you need to visualise architecture, flows, relationships, or any complex idea as a renderable diagram.
argument-hint: "[concept, system, data, or architecture to visualise as a Mermaid diagram]"
---
...
- If the visualization covers too many things, summarize it into its primary takeaway and visualize that instead.
