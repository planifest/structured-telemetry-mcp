...
description: Analyse server log files to identify patterns, anomalies, and reliability issues — covering error spikes, recurring failures, performance degradation, and actionable improvement recommendations.
argument-hint: "[paste server log file contents]"
---
