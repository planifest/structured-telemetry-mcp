---
name: cloud-security
description: Produce a network threat landscape report from open port and service scan data — covering description, risk assessment, recommendations, trends, and one-sentence summary for inclusion in formal security reports.
argument-hint: "[paste nmap or network port scan output with open ports and services]"
---
