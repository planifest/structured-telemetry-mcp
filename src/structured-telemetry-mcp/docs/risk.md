...
See `plan/current/security-report.md` (0000015) for the full STRIDE threat model — overall risk rating Low, one Medium finding (R-007 above), no Critical/High findings.
